...
export const CreateFile = (payload) =>{
    ...
    return axios.post(WEBSERVICE + '/directory/create_file', payload, {headers: {
...
export const Download = (obj) => {
    ...
    return axios.post(WEBSERVICE + '/files/download', payload, {
        responseType: 'blob',
        headers: { 'Content-Type': 'application/json','Authorization' : "bearer " + JSON.parse(atob(localStorage.getItem(SITENAMEALIAS + '_session'))).token}
    });
}
