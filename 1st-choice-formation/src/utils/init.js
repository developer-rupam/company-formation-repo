...
const PRODUCTIONOBJ = {url : 'https://hostingfordevelopment.000webhostapp.com/1st-choice-formation/dev ',api : 'http://127.0.0.1:6000/v1',baseurl : 'https://hostingfordevelopment.000webhostapp.com/smart-formation/dev/'};
