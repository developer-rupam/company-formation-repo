...
import { UpdateUser, addDirectoryAssignedUser, GetAllSubDirectory, CreateDirectory, sendUserCredential, GetUserDetails } from '../utils/service'
               ...
               let clientsList = response.response;
                ...
                setTimeout(() => {
                    ...
                    this.setState({
                        ...
                        hasPermissionToAccessPersonalSettings: clientsList.access_user_settings,
                        showLoader: false,
                        userCreatedBy: clientsList.created_by
                    })
