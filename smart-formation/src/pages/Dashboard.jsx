                                                ...
                                                <div className="recent_file_area">
                                                    <ul className="recent_file_item_list">
                                                        {this.state.recentFileList.map((list) =>
                                                            <li key={list.entity_id} onClick={()=>{this.handleFolderDetails(list.entity_id)}} class="pointer-cursor">
                                        ...
                                        <div className="card card_cstm same_dv_table">
                                            ...
                                            <div className="card-body custom_card_body_sortcut">
                                                ...
                                                <li><Link to="/dashboard"><span><i className="fas fa-reply"></i></span>Request Files</Link></li> */}
                                                        ...
                                                        {this.state.loggedInUserRole == 'ADMIN' && <li><Link to="/personal-folders"><span><i className="fas fa-folder"></i></span>Personal Folders</Link></li>}
                                                        ...
                                                        {this.state.loggedInUserRole == 'ADMIN' && <li className={this.state.hasAccessToManageClients ? '' : 'ml-2'} style={{ marginTop: '-36px' }}><Link to="/favorite-folders"><span><i className="fas fa-star"></i></span>Favorites</Link></li>}
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
